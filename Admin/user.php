...
<div class="container mt-5">
    <a href="#"  onclick="showPopupForm()">Új felhasználó hozzáadása</a>
    <h2>Felhasználó keresése e-mail alapján</h2>
    <form>
        <div class="form-group">
            <label for="userEmail">Felhasználó e-mail:</label>
            <input type="text" id="userEmail" name="userEmail" class="form-control" onkeyup="searchEmail()">
            <ul id="emailList" class="list-group mt-2"></ul>
        </div>
    </form>
    <!-- Popup ablak az új felhasználó létrehozásához -->
    <div id="popupForm" class="popup">
        <div class="popup-content">
            <span class="close" onclick="closePopupForm()">&times;</span>
            <h2>Új felhasználó létrehozása</h2>
            <div class="form-group">
                <label for="newFirstname">Vezetéknév:</label>
                <input type="text" id="newFirstname" name="newFirstname" class="form-control">
            </div>
            <div class="form-group">
                <label for="newLastname">Keresztnév:</label>
                <input type="text" id="newLastname" name="newLastname" class="form-control">
            </div>
            <div class="form-group">
                <label for="newPhone">Telefonszám:</label>
                <input type="text" id="newPhone" name="newPhone" class="form-control">
            </div>
            <div class="form-group">
                <label for="newEmail">E-mail cím:</label>
            ...
            <button type="button" class="button" onclick="createNewUser()">Felhasználó létrehozása</button>
        </div>
    </div>
    <!-- Vége a popup ablaknak -->
    <form id="userForm" class="mt-4" style="display: none;">
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="is_banned">Letiltva:</label>
            <input type="text" id="is_banned" name="is_banned" class="form-control">
        </div>
        <button type="button" class="btn btn-primary" onclick="saveChanges()">Mentés</button>
        <button type="button" class="btn btn-danger me-2" onclick="deleteUser()">Törlés</button>
    </form>
</div>
</body>
</html>
